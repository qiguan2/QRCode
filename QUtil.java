...
//        g.drawRoundRect(x, y, logoImage.getWidth(), logoImage.getHeight(), 10, 10);
    ...
    public static void main(String[] args) {
        ...
        String logoPath = "D:\\test\\ic_gcnt_small.png";
        String format = "jpg";
        int width = 180;
        int height = 220;
        ...
        String path = "D:/test/"+System.currentTimeMillis()+".png";
        try {
        ...
        String text = "该二维码只用于线下交易";
        String withTextPath = "D:/test/"+System.currentTimeMillis()+".png";
